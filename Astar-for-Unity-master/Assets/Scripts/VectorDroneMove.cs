...
using System.IO;
using GridMaster;
public class VectorDroneMove : MonoBehaviour
{
    ...
    {
        string dronepath = Application.dataPath + @"\Text\OurPath.txt";//좌표값이 적혀있는 txt파일 위치
